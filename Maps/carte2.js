function carte2() {
   ...
   */
  var svg = d3.select('.dessein').append("svg").classed("france",true);
      //.attr("width", width)
      //.attr("height", height);
   ...
   */
  d3.json('Maps/DEPARTEMENT2.json', function(req, geojson) {
    ...
    features.enter()
        .append("path")
            ...
            .attr('fill', function(d) { 
                return colorScale(+d.nameDep); 
            })
          .attr("d", path)
          .on('click', countyClickHandler)
          .append("text")
          .attr("font-size","15px")
          .text(function(d){ return d.nameDep+"";});
